...
public class  HelloWorldTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i] = new  StructMember("prefix", false, (short)-1,  false, new TypeCode(TCKind.TK_STRING,(HELLODDS_MAX_STRING_SIZE.VALUE)), 0, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        ...
        sm[__i] = new  StructMember("sampleId", false, (short)-1,  false, TypeCode.TC_LONG, 1, false, memberAnnotation);__i++;
        sm[__i] = new  StructMember("payload", false, (short)-1,  false, new TypeCode((HELLODDS_MAX_PAYLOAD_SIZE.VALUE), TypeCode.TC_OCTET), 2, false);__i++;
