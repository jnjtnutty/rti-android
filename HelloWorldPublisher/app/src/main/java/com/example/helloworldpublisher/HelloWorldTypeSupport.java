...
public class HelloWorldTypeSupport extends TypeSupportImpl {
    ...
    */
    ...
    public long get_serialized_sample_max_size(java.lang.Object endpoint_data,boolean include_encapsulation,short final_encapsulation_id,long currentAlignment) {
        ...
        currentAlignment +=_cdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((HELLODDS_MAX_STRING_SIZE.VALUE))+1);
        currentAlignment += _cdrPrimitiveType.getIntMaxSizeSerialized(currentAlignment) ;
        currentAlignment +=_cdrPrimitiveType.getByteSequenceMaxSizeSerialized(currentAlignment, (HELLODDS_MAX_PAYLOAD_SIZE.VALUE));
        if (include_encapsulation) {
        ...
        java.lang.Object sample)
    {
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.prefix );
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                src.readByteSequence(typedDst.payload, (HELLODDS_MAX_PAYLOAD_SIZE.VALUE));
